...
SECRET_KEY = 'django-insecure-@@qbywcddkev)204w!e1#fu#+greu2z0&#%%wu!)2)ymjq68hd'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Hoer5UhMT3dz',                 # Contraseña proporcionada por Neon
        'HOST': 'ep-silent-salad-a59rjxeq.us-east-2.aws.neon.tech',                      # Host (generalmente proporcionado por Neon)
